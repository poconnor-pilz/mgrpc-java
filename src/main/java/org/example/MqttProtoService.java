...
public interface MqttProtoService {
     ...
     * @param serverBufferObserver Method replies will be sent to this listener
     ...
     * @throws Exception
     */
    BufferObserver onProtoRequest(String method, ByteString requestParams, BufferObserver serverBufferObserver) throws Exception;
